...
education:
  ...
  - course: PhD Biology
    ...
    year: 2023
  - course: MSc in Life and Environmental Science
    institution: Brandon University
    year: 2018
  - course: Licenciatura Biotechnology Engineering
    institution: Costa Rica Institute of Technology
    year: 2015
  - course: BSc Biotechnology Engineering
    institution: Costa Rica Institute of Technology
    year: 2011
email: gustavo.diazcruz@ucr.ac.cr
highlight_name: no
interests:
- Plant pathology 
- Microbial ecology
...
- name: Universidad de Costa Rica
  url: https://ciproc.ac.cr
role: Researcher and lecturer
social:
- icon: envelope
  icon_pack: fas
  link: mailto:gustavo.diazcruz@ucr.ac.cr 
- display:
    header: yes
  icon: twitter
  icon_pack: fab
  label: Find me on Twitter
  link: https://twitter.com/gdiazcruz
- icon: google-scholar
  icon_pack: ai
  link: https://scholar.google.ca/citations?user=mUJjOd8AAAAJ&hl=en
superuser: yes
